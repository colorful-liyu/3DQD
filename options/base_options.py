...
class BaseOptions():
    ...
    def initialize(self):
        ...
        # model stuff
        self.parser.add_argument('--model', type=str, default='simple_multi_df', choices=['pvqvae', 'pvqvad', 'rand_tf', 'resnet2vq', 'bert2vq', 'df', 'textdf', 'multidf', 'simple_multi_df', 'imgdf'], help='chooses which model to use.')
        ...
        # vqvae stuff; need to load the corresponding vqvae weight for training diffusion
        self.parser.add_argument('--vq_model', type=str, default='vqvae', choices=['vqvae', 'pvqvae', 'pvqvad'], help='vqvae model to use.')
        ...
        # diffusion stuff
        self.parser.add_argument('--tf_cfg', type=str, default='configs/df_snet_code.yaml', help='df model config file')
