...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--lr_decay_iters', type=int, default=15, help='multiply by a gamma every lr_decay_iters iterations')
        ...
        self.parser.add_argument('--classifier_free', type=float, default='0.1', help='cf dropout rate')
        self.parser.add_argument('--guidew', type=float, default=0.5, help='# guide W when inference')
