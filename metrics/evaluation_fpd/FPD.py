...
from metrics.evaluation_fpd.pointnet import PointNetCls
...
def calculate_fpd(pointclouds1, pointclouds2=None, batch_size=100, dims=1808, device=None):
    ...
    PointNet_path = './metrics/evaluation_fpd/cls_model_39.pth'
    statistic_save_path = './metrics/evaluation_fpd/pre_statistics.npz'
